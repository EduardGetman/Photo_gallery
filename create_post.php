...
<?php require_once "tpl\\heder.php";?>
    <main>
        <form class="creating_profile_form content_cl" action="includes/upload_post.php" method="POST" enctype="multipart/form-data" >
            <h2 class="field_name">Загрузите картинку</h2>
            <div class="top_button">
                <input type="file" name="photo" accept="image/jpg">
                <input class ="button_cl"type="submit" value="Отправить">
            </div>
            <h2 class="field_name">Расскажите о фотографии</h2>
